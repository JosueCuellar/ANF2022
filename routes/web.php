...
Route::middleware(['auth'])->group(function(){
	...
	/*------------------------------------------- CUENTA-SISTEMA -------------------------------------------*/
	Route::get('/cuenta_equivalente', 'CuentaSistemaController@index')->name('cuenta_equivalente.index');
	//Vinculacion de cuenta
	Route::post('/cuenta_equivalente/{id_cuenta_sistema}', 'CuentaSistemaController@vinculacion')->name('cuenta_equivalente.vinculacion');
