                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-7 text-right">
                            <form action="">
                                <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#aniadir_manual">Agregar Cuenta</i></button>
                            </form>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="ml-auto col-md-12">
                                                    ...
                                                    <select class="form-control" name="tipoCuenta">
                                                        <option value="-1" class="selectorCorreccion">--Seleccionar un tipo de cuenta--</option>
                                                    ...
                                                    <form autocomplete="off" action="" name="padre">
                                                        <div>
                                                            <input id="buscador" class="form-control" type="text" name="cuenta_padre" placeholder="Codigo de cuenta principal (Ejem: 1 , 2) Si se agrega una principal no llenar esta campo" onclick="ejecutarBuscador({{$cuentas}},'codigo', 'buscador')">
                                                        </div>
                                                    </form>
                                                    <p><br></p>
                                                </div>
                            ...
                            <tbody>
                                ...
                                <tr id="{{$cuenta->id}}" onMouseOver="ResaltarFila({{$cuenta->id}});" onMouseOut="RestablecerFila({{$cuenta->id}}, '')">
                                    ...
                                    @if ($cuenta->padre_id==null)
                                        <td><p class="text-dark">{{$cuenta->nombre}}</p></td>
                                    @else
                                        <td>{{$cuenta->nombre}}</td>
                                    @endif
                                    ...
                                    <form id="formulario{{$cuenta->id}}" action="{{route('cuenta.destroy', $cuenta->id)}}" method="POST">
                                        ...
                                        <td>
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                @endif
                                                <!--boton de eliminar-->
                                                <button type="button"  class="btn btn-sm btn-warning" onclick="confirmar('formulario{{$cuenta->id}}')">
                                                Eliminar</button>
                                            </div>
