        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                    ...
                    @if (session('status'))
                        <div class="alert alert-dark">{{ session('status') }}</div>
                    @endif
                     @if (session('exito'))
                        ...
                        <div class="col-md-6">
                            ...
                            <table class="table tablesorter tablaCustom">
                                    ...
                                    @if ($cuenta->padre_id==$activo[0]->id)
                                        ...
                                        @foreach ($cuentasEmpresa as $cuenta3)
                                            ...
                                            <tr>
                                                <form id="insertar{{$cuenta3->id}}" action="{{route('cuenta_periodo.store', [$periodo, $cuenta3->id])}}" method="POST">
                                                    ...
                                                    <td><input value="{{$cuenta3->total}}" name="cuenta" class="form-control" type="number" step="0.01"></td>
                                                </form>
                                                <td>
                                        ...
                                        <tr>
                                            <form id="insertar{{$cuenta2->id}}" action="{{route('cuenta_periodo.storePadre', [$periodo, $cuenta2->id])}}" method="POST">
                                                ...
                                                <td><input value="{{$cuenta2->total}}" name="cuenta" class="form-control" type="number"  step="0.01"></td>
                                            </form>
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <!--boton de guardar-->
                                ...
                                <tr>
                                    ...
                                    <td><input value="{{$activo[0]->total}}" name="cuenta" class="form-control" type="number" step="0.01" disabled></td>
                                    <td></td>
                                </tr>
                            </table>
                        </div>
                            <div class="col-md-6">
                                ...
                                <table class="table tablesorter tablaCustom">
                                    ...
                                    <tr>
                                        ...
                                        <td><input value="{{$pasivo[0]->total}}" name="cuenta" class="form-control" type="number" step="0.01" disabled></td>
                                        <td></td>
                                    </tr>
                                </table>
                                <!--Tabla para capital-->
                                <table class="table tablesorter tablaCustom">
                                    ...
                                    <tr>
                                        ...
                                        <td><input value="{{$capital[0]->total}}" name="cuenta" class="form-control" type="number" step="0.01" disabled></td>
                                        <td></td>
                                    </tr>
                                    <tr>
                                        <td></td>
                                        <th class="text-danger">Total Pasivo + Capital</th>
                                        <td><input value="{{$capital[0]->total+$pasivo[0]->total}}" name="cuenta" class="form-control" type="number"  step="0.01" disabled></td>
                                        <td></td>
                                    </tr>
                                </table>
                            </div>
