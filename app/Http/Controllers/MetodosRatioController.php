...
public function calcular_rri($periodo, $empresa, $sector){   
    ...
    return [$razon_rotacion_inventario];
}
...
public function get_total($periodo, $cuenta){
    $resultado = DB::select(
        "SELECT CP.total AS total FROM cuenta_equivalente CS 
        JOIN cuenta_empresa VC ON CS.id = VC.id_cuenta_sistema 
